...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT CATEGORY, AMOUNT FROM PROJECTS LEFT JOIN PLEDGES ON PROJECTS.ID = PLEDGES.PROJECT_ID WHERE CATEGORY = 'music'; "
end

def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "SELECT CATEGORY, SUM(AMOUNT) FROM PROJECTS LEFT JOIN PLEDGES ON PROJECTS.ID = PLEDGES.PROJECT_ID WHERE CATEGORY = 'books' GROUP BY CATEGORY;"
end
